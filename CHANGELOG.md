...
### Added
- **antigravity-watcher.enableRetry**: New configuration setting to toggle automatic retries with exponential backoff when servers are under high traffic (429 errors).

### Changed
- **ReactorCore**: Refactored to support configurable fetch options and retry logic.
